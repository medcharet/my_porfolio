...
# Header 
st.write('''
# CHARET MOHAMED : INGENIEUR D'ETAT
##### *Resume* 
''')

image = Image.open('charet.png')
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color: #16A2CB;">
  <a class="navbar-brand" href="https://youtube.com/The learnning corner" target="_blank">The learning corner</a>
